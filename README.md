...
* **data** —— (Object)： 请求成功时返回的对象，如果请求发生错误，则为空。
  * Buckets —— (Array) ：说明本次返回的Bucket列表的所有信息
    ...
    * Location —— (String) ： Bucket 所在区域。枚举值：ap-beijing-1，ap-beijing，ap-shanghai，ap-guangzhou，ap-guangzhou-2，ap-chengdu，ap-singapore，ap-hongkong，na-toronto，eu-frankfurt。 ** 注意：旧的地域名称 cn-north ，cn-east，cn-south，cn-southwest，sg 分别对应新的地域名称 ap-beijing-1，ap-shanghai，ap-guangzhou， ap-chengdu， ap-singapore **
...
* **params** (Object) ： 参数列表
  ...
  * Region —— (String) ： Bucket 所在区域。枚举值：ap-beijing-1，ap-beijing，ap-shanghai，ap-guangzhou，ap-guangzhou-2，ap-chengdu，ap-singapore，ap-hongkong，na-toronto，eu-frankfurt。 ** 注意：旧的地域名称 cn-north ，cn-east，cn-south，cn-southwest，sg 分别对应新的地域名称 ap-beijing-1，ap-shanghai，ap-guangzhou， ap-chengdu， ap-singapore **
